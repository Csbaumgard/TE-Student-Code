<template>
  <div class="review" v-bind:class="{ favorited: review.isFavorited }" v-bind:key="review.id">
    ...
    <p>
      Favorite?
      <input type="checkbox" v-bind:checked="review.isFavorited" @change="onFavoritedChange">
    </p>
  </div>
</template>
